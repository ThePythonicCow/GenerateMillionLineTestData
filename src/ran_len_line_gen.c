/*
 * ran_len_line_gen [-n number_lines] - generate random short lines
 *
 * === Licensing:
 *
 ...
 *  MIT (see the "LICENSE-MIT.txt" file), and/or
 *  GNU GENERAL PUBLIC LICENSE Version 2 (see the COPYING.GPLv2 file).
 *
 * The PCG source code below is Copyright 2014 Melissa O'Neill
 * <oneill@pcg-random.org>, and is licensed by her under the
 * Apache License, Version 2.0 (see the "LICENSE-APACHE" file).
 *
 * === What ran_len_line_gen does:
 *
 ...
 * made available in both C (for now anyway just for gcc on Linux,
 * where I have decades of experience) and Rust (as a Rust
...
#define MAPLEN 32               /* compile time power of 2 (16, 32 or 64) */
...
const char *cmd = "ran_len_line_gen";
...
{
        fprintf(stderr, "ran_len_line_gen - generate many random short lines\n");
